        ...
        <div class="block" style="min-width: 50%;">
            ...
            <form method="post">
                <table border="0" cellspacing="0" cellpadding="0" width="100%">
                    <tbody>
                        <tr><td align="right"><fmt:message key="content.login" bundle="${txt}"/>: </td><td><input type="text" name="login" size="20" maxlength="15" value="${edititem.login}"></td></tr>
                        <tr><td align="right"><fmt:message key="content.password" bundle="${txt}"/>: </td><td><input type="password" name="password" size="20" maxlength="15" value=""></td></tr>
                        ...
                        <tr><td align="right"><fmt:message key="content.firstname" bundle="${txt}"/>: </td><td><input type="text" name="first_name" value="${edititem.firstName}" placeholder="<fmt:message key="content.firstname" bundle="${txt}"/>"></td></tr>
                        <tr><td align="right"><fmt:message key="content.lastname" bundle="${txt}"/>: </td><td><input type="text" name="last_name" value="${edititem.lastName}" placeholder="<fmt:message key="content.lastname" bundle="${txt}"/>"></td></tr>
