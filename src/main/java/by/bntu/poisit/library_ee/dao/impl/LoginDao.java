...
import by.bntu.poisit.library_ee.dao.interfaces.LoginDaoInterface;
...
public class LoginDao extends AbstractDao<Integer, Login> implements LoginDaoInterface {
    ...
    private static final String SQL_LOGIN_USER = "SELECT User1.id, User1.login, User1.password, User1.id_role, Role.name as role_name, User1.first_name, User1.last_name, User1.date_add, User1.last_login FROM User1 LEFT JOIN Role ON User1.id_role=Role.id WHERE login=? AND password=MD5(?) LIMIT 1";
    private static final String SQL_FIND_BY_ID = "SELECT User1.id, login, password, id_role, Role.name as role_name, first_name, last_name, User1.date_add, User1.last_login FROM User1 LEFT JOIN Role ON User1.id_role=Role.id WHERE User1.id=? LIMIT 1";
    private static final String SQL_FIND_BY_LOGIN = "SELECT User1.id, User1.login, User1.password, User1.id_role, Role.name as role_name, User1.first_name, User1.last_name, User1.date_add, User1.last_login FROM User1 LEFT JOIN Role ON User1.id_role=Role.id WHERE login=? LIMIT 1";
    private static final String SQL_INSERT = "INSERT INTO User1 (id, login, password, id_role, first_name, last_name, date_add,last_login) VALUES (default, ?, MD5(?), ?, ?, ?, NOW(), NOW())";
    private static final String SQL_UPDATE="UPDATE User1 SET login=?, password=?, id_role=?, first_name=?, last_name=?, last_login=? WHERE id=?";
    private static final String SQL_FIND_ALL="SELECT User1.id, User1.login, User1.password, User1.id_role, Role.name as role_name, User1.first_name, User1.last_name, User1.date_add, User1.last_login FROM User1 LEFT JOIN Role ON User1.id_role=Role.id ORDER BY date_add DESC";
    private static final String SQL_DELETE="DELETE FROM User1 WHERE id=? LIMIT 1";
    ...
    public Login findByLoginAndPassword(String userLogin, String userPassword){
        ...
        try {
            ...
            try {
                ...
                stmt = connection.prepareStatement(SQL_LOGIN_USER, ResultSet.TYPE_SCROLL_INSENSITIVE,
