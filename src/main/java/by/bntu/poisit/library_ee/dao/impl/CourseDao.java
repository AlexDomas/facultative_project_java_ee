...
public class CourseDao extends AbstractDao<Integer, Course> implements CourseDaoInterface {
    ...
    private static final String SQL_GET_ALL_BY_ID_TEACHER="SELECT Course.id, Course.date_add, Course.name, Course.id_teacher, User1.first_name, User1.last_name, count(Journal.id_student) as student_count FROM course JOIN User1 ON Course.id_teacher=User1.id LEFT JOIN journal ON Course.id=Journal.id_course where id_teacher = ? GROUP BY Course.id ORDER BY date_add DESC";
    private static final String SQL_GET_ALL="SELECT Course.id, Course.date_add, Course.name, Course.id_teacher, User1.first_name, User1.last_name, count(Journal.id_student) as student_count FROM Course LEFT JOIN User1 ON Course.id_teacher=User1.id LEFT JOIN Journal ON Course.id=Journal.id_course GROUP BY Course.id ORDER BY date_add DESC";
    private static final String SQL_INSERT="INSERT INTO Course (date_add, name, id_teacher) VALUES (?, ?, ?)";
    private static final String SQL_FIND_BY_PK="SELECT Course.id, Course.date_add, Course.name, Course.id_teacher, User1.first_name, User1.last_name FROM Course  LEFT JOIN User1 ON Course.id_teacher=User1.id WHERE Course.id=? LIMIT 1";
    ...
    private static final String SQL_GET_ALL_WITH_SUBSCRIBE="SELECT Course.id, Course.date_add, Course.name, Course.id_teacher, u1.first_name, u1.last_name, count(IF(id_student=?,1,null)) as sub, IF(id_student=?,j.mark,null) as mark, IF(id_student=?,j.note,null) as note FROM Course LEFT JOIN User1 AS u1 ON Course.id_teacher=u1.id LEFT JOIN Journal as j ON Course.id=j.id_course GROUP BY Course.id ORDER BY date_add DESC";
    private static final String SQL_GET_ALL_WITH_SUBSCRIBEST="SELECT Course.id, Course.date_add, Course.name, Course.id_teacher, u1.first_name, u1.last_name, count(IF(id_student=?,1,null)) as sub, IF(id_student=?,j.mark,null) as mark, IF(id_student=?,j.note,null) as note FROM Course LEFT JOIN User1 AS u1 ON Course.id_teacher=u1.id LEFT JOIN Journal as j ON Course.id=j.id_course where id_student=? GROUP BY Course.id ORDER BY date_add DESC";
